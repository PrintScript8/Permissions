...
class UserSnippetsTest {
    ...
    fun `test UserSnippets parameterized constructor`() {
        ...
        val userSnippets = UserSnippets("st-id", "Test User", ownerIds, collaboratorIds)
    ...
    fun `test UserSnippets owner modification`() {
        val userSnippets = UserSnippets("st-id", "Test User", listOf(1L), listOf(2L))
